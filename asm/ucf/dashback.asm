...
# https://github.com/project-slippi/slippi-ssbm-asm/blob/0ca890f4a0a6dfe2ce42570892218428327a3168/External/UCF%200.8/Logic/UCF%20DB.asm
################################################################################
.include "../common.s"
...
#Get Nana's Block From Popo's in r4
	...
	branchl	r12, Player_GetEntityAtIndex
	cmpwi	r3,0x0
	beq	Injection_Exit
	lwz	r4,0x2C(r3)
