...
loop_control:
    ...
    # If the player count is less than 5 player we cancel all of this code.
    cmpli 0, reg_player_count, 5
    blt Exit_no_restore
    # Continue with the initialization of the transparent HUD system.

# ======================================
# ===== End triples modifications. =====
# ======================================
